...
export const Dashboard: React.FC<DashboardProps> = ({
  ...
  const biweeklyIncomeAvg = data.config.monthlyFixedIncome / 2;
  ...
  return (
    <div className="space-y-6 pb-12">
          ...
          >
            ...
            <div className="mt-2">
              ...
              <div className="flex items-center justify-between text-[11px] text-slate-500 mt-1">
                ...
                <span className="text-rose-600 font-semibold group-hover:underline">Ver detalle →</span>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="mt-2">
              ...
              <div className="flex items-center justify-between text-[11px] text-slate-500 mt-1">
                ...
                <span className="text-teal-600 font-semibold group-hover:underline">Ver metas →</span>
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">Acumulado y progreso hacia metas</p>
              </div>
            </div>
        ...
        {/* Right: Próximos Movimientos Programados a Futuro */}
        <div className="bg-white rounded-2xl border border-slate-200/90 shadow-2xs p-5 space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">Ingresos y compromisos futuros planificados</p>
              </div>
            </div>
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <span className="text-[10px] text-slate-500">Fecha: {tx.date}</span>
                    </div>
                  </div>
