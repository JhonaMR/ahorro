      ...
      <div className="bg-white rounded-2xl border border-slate-200/90 shadow-2xs p-5 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 border-t border-slate-100">
          ...
          <div className="p-3 rounded-xl bg-rose-50/60 border border-rose-200/60 text-xs">
            <span className="text-rose-700 font-medium block">Total Gastos / Compromisos Futuros</span>
          ...
          scheduledList.map((tx) => {
            ...
            return (
              <div
                ...
                className="bg-white rounded-2xl border border-slate-200/90 hover:border-slate-300 transition-all shadow-2xs p-4 flex flex-wrap items-center justify-between gap-4"
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button
                    ...
                    className="px-2.5 py-1.5 text-xs font-semibold text-indigo-700 bg-indigo-50 hover:bg-indigo-100 rounded-lg transition-colors cursor-pointer flex items-center gap-1"
