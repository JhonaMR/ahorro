...
import { calculateDebtLiquidationInfo, formatCurrency, getPeriodKey } from '../utils/formatters';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs">
      ...
      >
        ...
        <div className="flex items-center gap-3 border-b border-slate-100 pb-4 mb-4">
          ...
          <div>
            <h3 className="text-base font-bold text-slate-900">Registrar Pago de Cuota</h3>
            <p className="text-xs text-slate-500 font-medium">{debt.title}</p>
          </div>
        </div>
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 mb-4 text-xs space-y-1.5">
          ...
          <div className="flex justify-between">
            <span className="text-slate-500">Valor Cuota Normal:</span>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-7 pr-3 py-2 text-sm font-bold text-slate-900 focus:ring-2 focus:ring-rose-500 focus:outline-none"
              />
            </div>
          </div>
          ...
          <div>
            <label className="flex items-center gap-2 cursor-pointer text-xs font-semibold text-slate-700 bg-slate-50 p-2.5 rounded-xl border border-slate-200">
              ...
              />
              <span>Es un abono extraordinario a capital (no cuota regular)</span>
            </label>
          </div>
