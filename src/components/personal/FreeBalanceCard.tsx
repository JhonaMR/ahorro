...
export const FreeBalanceCard: React.FC<FreeBalanceCardProps> = ({
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 pb-4 text-xs font-semibold text-slate-500">
        ...
        <div className="text-right">
          ...
          <span
            className={`text-2xl font-extrabold tracking-tight ${
              isPositive ? 'text-emerald-700' : isZero ? 'text-slate-705' : 'text-rose-600'
            }`}
          >
        ...
        <div className="mt-5 space-y-5">
          ...
          <div>
            <div className="flex justify-between text-xs font-semibold mb-1.5">
              <span className="text-indigo-750 flex items-center gap-1.5">
