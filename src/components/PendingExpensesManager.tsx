      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5">
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200/90 shadow-2xs">
          <div className="flex items-center justify-between text-slate-500 text-xs mb-1.5">
            <span className="font-semibold">En Lista de Espera</span>
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200/90 shadow-2xs">
          <div className="flex items-center justify-between text-slate-500 text-xs mb-1.5">
            <span className="font-semibold">Por Cobrar a Otros</span>
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200/90 shadow-2xs">
          <div className="flex items-center justify-between text-slate-500 text-xs mb-1.5">
            <span className="font-semibold">Recuperado / Cobrado</span>
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200/90 shadow-2xs">
          <div className="flex items-center justify-between text-slate-500 text-xs mb-1.5">
            <span className="font-semibold">Gastos Compartidos</span>
        ...
        <div className="space-y-3">
          {filteredExpenses.map((expense) => {
            ...
            return (
              ...
              >
                {/* Main Card Header / Row - Clickable to expand/collapse */}
                <div
                  ...
                  <div className="space-y-1.5 flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {isShared && nonOwnerParticipants.length > 0 && (
                        <span className="hidden md:inline-flex text-[11px] font-semibold text-slate-500 bg-slate-100/90 px-2 py-0.5 rounded-md">
                ...
                {/* Expanded Details Section (Participants, Shares, Payments or Details) */}
                {isExpanded && (
                                ...
                                {!p.isOwner && !isDone && (
                                  <div className="pt-2 border-t border-slate-100 flex items-center justify-between gap-2">
                                    ...
                                    <button
                                      ...
                                      className="flex items-center gap-1 text-xs font-bold text-teal-700 hover:text-teal-800 bg-teal-50 hover:bg-teal-100 px-3 py-1.5 rounded-lg border border-teal-200 transition cursor-pointer"
                                    >
                                ...
                                {p.payments && p.payments.length > 0 && (
                                  <div className="pt-2 border-t border-slate-100 text-[11px] text-slate-500 space-y-1">
                                    <div className="font-semibold text-slate-700 flex items-center gap-1 text-xs">
                                      <History className="w-3 h-3 text-slate-400" /> Historial de Abonos ({p.payments.length}):
                                    </div>
                                    {p.payments.map((pay) => (
