    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs">
      ...
      >
        ...
        <div className="flex items-center gap-3 border-b border-slate-100 pb-4 mb-4">
          ...
          <div>
            <h3 className="text-base font-bold text-slate-900">Registrar Depósito / Aporte</h3>
            <p className="text-xs text-slate-500 font-medium">{savings.name}</p>
          </div>
        </div>

        {/* Current status */}
        <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 mb-4 text-xs space-y-1.5">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-7 pr-3 py-2 text-sm font-bold text-slate-900 focus:ring-2 focus:ring-teal-500 focus:outline-none"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="ej. Transferencia a bolsillo Nu, compra dólares..."
          ...
          <div className="flex items-center justify-end gap-3 pt-3 border-t border-slate-100">
            ...
            <button
              ...
              className="px-5 py-2 text-xs font-bold text-white bg-teal-600 hover:bg-teal-700 rounded-xl shadow-xs transition-colors cursor-pointer flex items-center gap-1.5"
            >
